...
As defined further in the Moneff Open Banking API Specification
...
> The request object used in OIDC flows the aud claim is the issuer url from the Moneff ASPSP .wellknown endpoint (linked below).
